...
This directory contains Kopern-OS integrations and converted formats for
...
Kopern-OS was originally designed for Claude Code. Agents work natively
without conversion.
...
Kopern-OS also works natively with GitHub Copilot. Agents can be copied
...
The extension is installed to `~/.gemini/extensions/kopern-os-agents/`.
...
```bash
cd /your/project && /path/to/kopern-os/agents/scripts/install.sh --tool opencode
```
...
```bash
cd /your/project && /path/to/kopern-os/agents/scripts/install.sh --tool cursor
```
...
```bash
cd /your/project && /path/to/kopern-os/agents/scripts/install.sh --tool aider
```
...
```bash
cd /your/project && /path/to/kopern-os/agents/scripts/install.sh --tool windsurf
```
...
```bash
cd /your/project && /path/to/kopern-os/agents/scripts/install.sh --tool qwen
```
