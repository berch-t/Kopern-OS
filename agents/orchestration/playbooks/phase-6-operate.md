...
New features follow a compressed Kopern Conductor cycle:
...
*Phase 6 has no end date. It runs as long as the product is in market, with continuous improvement cycles driving the product forward. The Kopern Conductor pipeline can be re-activated (Conductor-Sprint or Conductor-Micro) for major new features or pivots.*
