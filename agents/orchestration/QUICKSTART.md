# ⚡ Kopern Conductor Quick-Start Guide

> **Get from zero to orchestrated multi-agent pipeline in 5 minutes.**

---

## What is Kopern Conductor?

**Kopern Conductor** (Network of EXperts, Unified in Strategy) turns Kopern-OS's AI specialists into a coordinated pipeline. Instead of activating agents one at a time and hoping they work together, Kopern Conductor defines exactly who does what, when, and how quality is verified at every step.

## Choose Your Mode

| I want to... | Use | Agents | Time |
|-------------|-----|--------|------|
| Build a complete product from scratch | **Conductor-Full** | All | 12-24 weeks |
| Build a feature or MVP | **Conductor-Sprint** | 15-25 | 2-6 weeks |
| Do a specific task (bug fix, campaign, audit) | **Conductor-Micro** | 5-10 | 1-5 days |

---

## 🚀 Conductor-Full: Start a Complete Project

**Copy this prompt to activate the full pipeline:**

```
Activate Agents Orchestrator in Conductor-Full mode.

Project: [YOUR PROJECT NAME]
Specification: [DESCRIBE YOUR PROJECT OR LINK TO SPEC]

Execute the complete Kopern Conductor pipeline:
...
## 🏃 Conductor-Sprint: Build a Feature or MVP

**Copy this prompt:**

```
Activate Agents Orchestrator in Conductor-Sprint mode.
...
## 🎯 Conductor-Micro: Do a Specific Task
...
|----------|---------|----------|
| **Master Strategy** | Complete Kopern Conductor doctrine | `strategy/conductor-doctrine.md` |
| **Phase 0 Playbook** | Discovery & intelligence | `orchestration/playbooks/phase-0-discovery.md` |
| **Phase 1 Playbook** | Strategy & architecture | `orchestration/playbooks/phase-1-strategy.md` |
| **Phase 2 Playbook** | Foundation & scaffolding | `orchestration/playbooks/phase-2-foundation.md` |
| **Phase 3 Playbook** | Build & iterate | `orchestration/playbooks/phase-3-build.md` |
| **Phase 4 Playbook** | Quality & hardening | `orchestration/playbooks/phase-4-hardening.md` |
| **Phase 5 Playbook** | Launch & growth | `orchestration/playbooks/phase-5-launch.md` |
| **Phase 6 Playbook** | Operate & evolve | `orchestration/playbooks/phase-6-operate.md` |
| **Activation Prompts** | Ready-to-use agent prompts | `orchestration/coordination/agent-activation-prompts.md` |
| **Handoff Templates** | Standardized handoff formats | `orchestration/coordination/handoff-templates.md` |
| **Startup MVP Runbook** | 4-6 week MVP build | `orchestration/runbooks/scenario-startup-mvp.md` |
| **Enterprise Feature Runbook** | Enterprise feature development | `orchestration/runbooks/scenario-enterprise-feature.md` |
| **Marketing Campaign Runbook** | Multi-channel campaign | `orchestration/runbooks/scenario-marketing-campaign.md` |
| **Incident Response Runbook** | Production incident handling | `orchestration/runbooks/scenario-incident-response.md` |
...
`strategy/conductor-doctrine.md` — The complete doctrine
