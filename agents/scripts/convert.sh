#!/usr/bin/env bash
#
# convert.sh — Convert Kopern-OS agent .md files into tool-specific formats.
#
...
# Kopern-OS Catalog — AI Agent Rules for Windsurf
#
# Full roster of specialized AI agents from Kopern-OS Catalog.
...
main() {
  ...
  header "Kopern-OS Catalog -- Converting agents to tool-specific formats"
  echo "  Repo:   $REPO_ROOT"
  echo "  Output: $OUT_DIR"
  echo "  Tool:   $tool"
  echo "  Date:   $TODAY"
